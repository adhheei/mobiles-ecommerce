...
const cancelOrder = async (req, res) => {
    try {
        ...
        if (order.paymentStatus === 'Paid' && (targetStatus === 'Returned' || targetStatus === 'Cancelled')) {
...
const getAdminOrderDetails = async (req, res) => {
    try {
        ...
        const order = await Order.findOne(query)
            .populate('userId', 'firstName lastName email mobile') // Populate user details
            .populate('items.productId', 'name image price'); // Populate product info if needed
