      ...
      if (data.success) {
        ...
        if (data.user.profileImage) {
          ...
          if (!imgSrc.startsWith("http")) {
            ...
            imgSrc += (imgSrc.includes("?") ? "&" : "?") + `t=${timestamp}`;
          }
        ...
        async (blob) => {
          ...
          try {
            ...
            if (data.success) {
              ...
              const modalInstance =
                bootstrap.Modal.getInstance(cropModalElement);
              modalInstance.hide();
              ...
              if (newSrc.startsWith("public/")) newSrc = newSrc.replace("public/", "");
              ...
              const timestamp = new Date().getTime();
              newSrc += (newSrc.includes("?") ? "&" : "?") + `t=${timestamp}`;
